  ...
  return (
    <nav className="flex items-center lg:justify-around justify-between p-4 bg-white shadow-md sticky top-0 z-50">
      ...
      <div className="hidden md:flex space-x-6">
        <Link href="#" className="text-gray-600 hover:text-gray-800">Agents</Link>
        <Link href="#" className="text-gray-600 hover:text-gray-800">Land Owners</Link>
        <Link href="#" className="text-gray-600 hover:text-gray-800">Developers</Link>
        <Link href="#" className="text-gray-600 hover:text-gray-800 flex items-center">
          <span className="mr-1">Services</span>
          <span className="text-yellow-500">•</span>
        </Link>
        <Link href="#" className="text-gray-600 hover:text-gray-800">All Lands</Link>
      </div>
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-16 left-0 w-full bg-white shadow-md p-4 flex flex-col space-y-4 transition-all duration-300 md:hidden">
          <Link href="#" className="text-gray-600 hover:text-gray-800" onClick={() => setIsMobileMenuOpen(false)}>Agents</Link>
          <Link href="#" className="text-gray-600 hover:text-gray-800" onClick={() => setIsMobileMenuOpen(false)}>Land Owners</Link>
          <Link href="#" className="text-gray-600 hover:text-gray-800" onClick={() => setIsMobileMenuOpen(false)}>Developers</Link>
          <Link href="#" className="text-gray-600 hover:text-gray-800" onClick={() => setIsMobileMenuOpen(false)}>Services</Link>
          <Link href="#" className="text-gray-600 hover:text-gray-800" onClick={() => setIsMobileMenuOpen(false)}>All Lands</Link>
          <button
